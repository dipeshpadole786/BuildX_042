...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', backgroundColor: colors.surface, borderRadius: 999, padding: 4, gap: 4 },
  tab: { flex: 1, minHeight: 40, borderRadius: 999, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
